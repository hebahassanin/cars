    ...
    <div className='container-fluid py-4'>
        <div className='row'>
            <div className='col-md-6 d-flex justify-content-center align-items-center chooseUs-bg'>
                <img src={carImg} className='w-100 me-4' alt=''/>
            </div>
            <div className='col-md-6'>
                <SectionHeading subtitle="why choose us" title="We offer the best experience with our rental deals"/>
                <div className='row'>
                    <div className='col-md-2 my-2'>
                        <img src={logo1} className='w-75' alt='logo1'/>
                    </div>
                    <div className='col-md-10 chooseUs-info'>
                ...
                <div className='row'>
                    <div className='col-md-2 my-2'>
                        <img src={logo2} className='w-75' alt='logo2'/>
                    </div>
                    <div className='col-md-10'>
                ...
                <div className='row'>
                    <div className='col-md-2 my-2'>
                        <img src={logo3} className='w-75' alt='logo3'/>
                    </div>
                    <div className='col-md-10'>
